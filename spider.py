...
class Crawl():
    ...
    def get_headers(self) -> dict:
        ...
        :return: Returns the headers object in the crawler object
        """
        return self.headers
    ...
    def _xpath(doc: Any, xpath: str = None):
        ...
        assert isinstance(doc, [str, bytes, etree._Element]), '[W] Can not recognize the type of param \'doc\''
    ...
    def json_crawl(self, doc: str = None, url: str = None, _key: str = None):
        """
        For crawling and formatting json data. it can receive dde string object returned by Response,
        or it can get the json data through the 'url'.
    ...
    def save(contents, file_prefix: str = 'saved',file_suffix: str = '.jpg',file_dir: str = './',\
        ...
        :param contents    : the content stored in the file, or the URL to get the content, used with
                            'is_url' param
        :param file_prefix : stroed filename prefix. Default=saved
